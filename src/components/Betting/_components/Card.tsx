...
const Card: React.FC<Props> = ({ type, amount, handleBet }) => {
  return (
    <div
    ...
    >
      <div className="group h-8 px-1 flex items-center gap-x-1 text-sm leading-none font-semibold bg-white rounded-full border-[3px] border-blue-500 cursor-default">
        <button
